        ...
        >
            <div className='carousel-inner'>
                <div className='carousel-item active overflow-hidden'>
                    ...
                    <div className='overlay' data-tilt-axis='x'>
                        <div className='overlay-content h-100'>
                            <div className='carousel-date d-flex flex-column justify-content-center align-items-center align-self-center ms-3'>
                                <span className='carousel-date-number'>٣٠</span>
                            ...
                            <div className='carousel-data'>
                                ...
                                <h2>
                                    وزير البترول يتابع خطط شركات الأنتاج بمنطقة
                                    الصحراء الغربية
                                </h2>
                                <p className='mt-3'>
                                    أكد المهندس طارق الملا وزير البترول والثروة
                                    المعدنيةزأن الفترة الحالية تتطلب المزيد من
                                    الجهود والحلول الأبتاكريه لزيادة الأنتاج من
                                    الثروةالبترولية في ظل الأسعار العالمية
                                    الحالية
                                </p>
                                <div>
